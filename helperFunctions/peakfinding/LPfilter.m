function [filt] = LPfilter(dat,Fs,Flp,N,type,dir,instabilityfix)
...
try
  ...
  switch instabilityfix
    ...
    case 'reduce'
      ...
      filt = LPfilter(dat,Fs,Flp,N-1,type,dir,instabilityfix);
    case 'split'
      N1 = ceil(N/2);
      N2 = floor(N/2);
      warning('backtrace', 'off')
      ...
      warning('backtrace', 'on')
      filt1 = LPfilter(dat  ,Fs,Flp,N1,type,dir,instabilityfix);
      filt  = LPfilter(filt1,Fs,Flp,N2,type,dir,instabilityfix);
    otherwise
