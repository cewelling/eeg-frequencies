function [filt] = BPfilter(dat,Fs,Fbp,N,type,dir,instabilityfix)
...
%
%example
%[filt] = BPfilter(dat,Fs,Fbp,[],'fir','twopass','no');
...
try
  ...
  switch instabilityfix
    ...
    case 'reduce'
      ...
      filt = BPfilter(dat,Fs,Fbp,N-1,type,dir,instabilityfix);
    case 'split'
      N1 = ceil(N/2);
      N2 = floor(N/2);
      warning('backtrace', 'off')
      ...
      warning('backtrace', 'on')
      filt1 = BPfilter(dat  ,Fs,Fbp,N1,type,dir,instabilityfix);
      filt  = BPfilter(filt1,Fs,Fbp,N2,type,dir,instabilityfix);
    otherwise
