function [ transitions ] = aggTransitions(parName, iPar, runName, date, EEGfile)
...
if exist(['rls_data/smoothedRLS/' parName '_' runName '_' analFreqLabel '.mat'], 'file') 
    load(['rls_data/smoothedRLS/' parName '_' runName '_' analFreqLabel '.mat'])
else
