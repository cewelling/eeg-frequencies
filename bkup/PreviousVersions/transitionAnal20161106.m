...
clearvars -except pars; close all; clc;
% setFigProps
...
pars = [133]; % participant ID num - select which participant to run

runsOfInt = [1 2 3];  % select the runs to look at, should be from a single stim/trial type %rival/darts:[1 2 3], sim/darts:[4 5 6], rival/marz:[7 8 9]
runType = 'rival'; % 'rival' or 'sim', change this to analyze correclty and safe with appropriate title
