...
parNums = [190];%[1:13 15:20]; %[1 7 20]; % ex/ Stratus100's parNum is 100
group = 'stratus'; % 'stratus' or 'cumulus'
runTypes = {'dartRival' 'dartSim'}; %'dartSim', 'marzRival'
runIndices = [1:3]; % generally 1:3

stimFreqs = [5.666 8.5]; % intermodulation frequencies: [2.833 14.166]; %[5.666 8.5];
...
electrodeSets = [occipitals]; %focusElectrode; %[occipitals]; 
numElecs =  7; %1; %7;
