...
%
% RUN rateFFT.m with all participants before running this script
%
% Called by:
...
%% How many good trials must a participant have to include them?
oddThresh = 5;
evenThresh = 5;
...
for iGroup = 1:length(groupParNums)
    ...
    for parNum = groupParNums{iGroup}
        ...
        if oNum > oddThresh && eNum > evenThresh
