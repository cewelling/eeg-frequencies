function [trainingData, testData, trainingLabels, testLabels] = makeSVMmatrices(parName, segPoints, trainSet, testSet, domSegMid_sim, domSegMid_riv, mixSegProp, teStartPt, teEndPt, rivLat, numStates)
...
if strcmp(trainSet, 'sim') || strcmp(trainSet, 'rivalry')
    ...
    for channel = channels
        for freqType = freqTypes
            ...
            [lowSegList, highSegList, labelVect] = getSVMSegs(parName, date, trainType, domSegMid, mixSegProp, segPoints, channel, freqType{1}, numStates);
...
if strcmp(testSet, 'rivalry')
    ...
    for channel = channels
        for freqType = freqTypes
            ...
            [lowSegList, highSegList, labelVect] = getSVMSegs(parName, date, 1, domSegMid_riv, mixSegProp, segPoints, channel, freqType{1}, numStates);
