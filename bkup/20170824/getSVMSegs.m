function [ lowSegList, highSegList, labelVect ] = getSVMSegs( parName, date, trainType, domSegProp, mixSegProp, segPoints, channel, freqType, numStates )
%getSegs uses button press data and sim schedules
    ...
    for runIndex = runIndices
        ...
        for iTrial = 1:numTrials
            ...
            if strcmp(segPlotOrNot, 'yes')
                ...
                load('rls_data/smoothedRLS/cumulus01_dartRival1_principles_Oz.mat')
            ...
            for iEpoch = 1:size(trialEpochs,1)
                ...
                % ... for dominant epoch
                    ...
                    if trainType == 2 % sim
                        eMid = eEnd - domSegProp; % Here, domSegProp is really absolute time before end of segment, rather than a proportion of the segment
                    elseif trainType == 1 % rivalry
