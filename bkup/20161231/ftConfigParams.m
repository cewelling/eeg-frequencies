...
elseif ~isempty(strfind(EEGfile, 'cumulus06'))
 ...
 % TEST (COMMENT OUT DURING REAL RUNS) cumulus03 
%   if ~isempty(strfind(EEGfile, 'cumulus03_dartRival1')) 
%       all_data = removeTrials(all_data, 5, 1);
%   end
...
elecsChosen = [2 19]; % include elecs to be analyzed, plotted
testElecs = {};
