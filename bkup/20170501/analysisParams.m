...
group = 0;
if group == 0
    parNums = [137]; %[105:140]; % ex/ Stratus100's parNum is 100
...
analFreqs = stimFreqs; % stimFreqs; % harFreqs;
...
numElecs =  1; %1; %7; % select numElecs best electrodes for each run
commonElecs = 1; % find commonElecs electrodes common across all dart runs (or marz runs) to use in analysis
